...
export const personalSkillsTR = [
  ...
  },
  {
    ...
    info: "Problem çözmek, yazılım geliştirme sürecinin temel bir parçasıdır. Zorluklarla karşılaştığımda çözüm bulmak için analitik düşünme becerilerimi kullanabilirim.",
    category: "personal",
  },
  {
    ...
    info: "Başarılı projeler için ekip içinde işbirliği şarttır. Farklı uzmanlık alanlarından insanlarla uyumlu bir şekilde çalışabilirim.",
    category: "personal",
  },
  {
    name: "Zaman Yönetimi",
...
export const developerSkillsTR = [
  {
    name: "Web Geliştirme",
    completed: 100,
    image: "/assets/skills/web.webp",
    info: "Web geliştirme konusunda profesyonel olmasa da iyi bir deneyime sahip olduğumu düşünüyorum. Ön uç ve arka uç teknolojilerini kullanarak kullanıcı dostu ve işlevsel web uygulamaları oluşturabilirim.",
    category: "developer",
  },
  {
    ...
    info: "RESTful API'leri etkili bir şekilde entegre edebilirim. API çağrıları yapma ve veri alışverişi için yanıtları işleme konusunda yetenekliyim.",
    category: "developer",
  },
  {
    name: "Git Sürüm Kontrolü",
    completed: 93,
    image: "/assets/skills/git.png",
    info: "Git kullanarak sürüm kontrolünü ve işbirliğini etkili bir şekilde yönetebilirim. Çeşitli dallar oluşturarak ve birleştirerek kod tabanını düzenleme konusunda deneyimliyim.",
    category: "developer",
  },
  {
    ...
    info: "Veritabanı yönetimi konusunda becerilerim var. SQL ile çok az deneyimim olmasına rağmen, NoSQL veritabanları ile çalışabilirim ve veri işleme ve depolama konusunda deneyimim var.",
    category: "developer",
  },
  {
    name: "Test ve Hata Ayıklama",
    completed: 60,
    image: "/assets/skills/test.png",
    info: "Test ve hata ayıklama konusunda elimden gelenin en iyisini yapmaya çalışıyorum.",
    category: "developer",
  },
];
...
export const qaTR = [
  ...
  {
    questionId: 2,
    question: "En büyük teknik zorlukları nasıl çözüyorsun?",
    answer:
      "Büyük teknik zorlukları çözerken, öncelikle sorunu derinlemesine anlayarak, çeşitli kaynakları araştırarak ve benzer çözümler arayarak yaklaşıyorum. Sorunu parçalara ayırıp adım adım bir çözüm oluşturuyor, ardından çözümü test ediyor ve gerektiğinde ayarlamalar yapıyorum. Farklı bakış açılarından yararlanarak bulduğum çözümleri not ediyorum ve bu süreçler sayesinde sorunları çözmeyi ve aynı zamanda öğrenme fırsatları yaratmayı başarıyorum.",
  },
  {
    questionId: 3,
    question: "Neden bir ön uç geliştiricisi olmak istiyorsun?",
    answer:
      "Ön uç geliştiricisi olmayı seçmemin temel nedeni, yaratıcılığımı teknik becerilerimle birleştirerek dijital dünyada etkileşimli ve kullanıcı merkezli deneyimler yaratma isteğimdir. Web sitelerini ve uygulamaları daha etkileyici, erişilebilir ve kullanımı kolay hale getirmek için tasarım ve kodlama becerilerimi birleştirerek dijital ortamda insanların daha iyi bir deneyim yaşamasına katkıda bulunmak istiyorum.",
  },
  {
    questionId: 4,
    question: "Ekip içinde nasıl iletişim kurarsın?",
    answer:
      "Ekip içinde iletişim kurarken öncelikle etkin dinleme becerilerimi kullanarak diğer üyelerin görüşlerini anlamaya çalışırım. Düşüncelerimi açık ve net bir şekilde ifade ederken farklı fikirleri dikkate alarak olumlu bir ortamı desteklerim. Soru sormak ve geri bildirim almak için aktif olarak iletişim kurarım ve gerektiğinde herkesin aynı sayfada olduğundan emin olmak için yazılı iletişim araçları aracılığıyla ayrıntıları paylaşırım.",
  },
  {
    questionId: 5,
    question:
      "Projelerini geliştirirken hangi tasarım ilkelerini takip ediyorsun?",
    answer:
      "Projelerimi geliştirirken kullanıcı merkezlilik, sadelik ve erişilebilirlik gibi temel tasarım ilkelerine dikkat ediyorum. Kullanıcıların ihtiyaçlarına odaklanarak kullanıcı deneyimini geliştirmeyi hedefliyorum. Kullanıcıların hedeflerine hızla ulaşabilmeleri için sade ve temiz tasarımlarla karmaşıklığı azaltmayı hedeflerken, erişilebilirlik ilkelerini gözeterek herkesin içeriğe kolayca ulaşabilmesini sağlamaya gayret ediyorum. Renk, tipografi ve düzen gibi estetik faktörleri de dengeleyerek projelerin hem işlevsel hem de görsel olarak etkileyici olmasını sağlıyorum.",
  },
];
